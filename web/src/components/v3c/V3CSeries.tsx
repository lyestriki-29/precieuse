...
const ROTATIONS = ["rotate-1", "-rotate-1", "rotate-[0.5deg]", "-rotate-[1.5deg]", "rotate-[1.5deg]"] as const;
  ...
  return (
    ...
    >
      <rect x="8" y="10" width="384" height="480" rx="1"
        stroke="#3d2817" strokeWidth="0.8" strokeDasharray="3 7"
        strokeOpacity="0.25" />
